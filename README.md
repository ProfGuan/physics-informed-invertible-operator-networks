...
## Citation
```bibtex
@inproceedings{zhang2026geophysics,
  title={Geophysics-informed invertible operator networks for solving Bayesian geophysical inverse problem
  author={Yangwen Zhang, Xintong Wang, Xiaofei Guan, and Peng Yu},
  year={2026}
}
